@REM prototypeplay launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM PROTOTYPEPLAY_config.txt found in the PROTOTYPEPLAY_HOME.
@setlocal enabledelayedexpansion

@echo off


if "%PROTOTYPEPLAY_HOME%"=="" (
  set "APP_HOME=%~dp0\\.."

  rem Also set the old env name for backwards compatibility
  set "PROTOTYPEPLAY_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%PROTOTYPEPLAY_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\PROTOTYPEPLAY_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running prototypeplay.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !PROTOTYPEPLAY_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
